...
def Get_task():
    messagebox.showinfo("Information", "Задание:\nНайти такой треугольник, у которого разность " +
        "минимального и максимального количеств точек, " +
        "попавших в каждый из 6-ти треугольников, " +
        "образованных пересечением биссектрис, " +
        "минимальна.")
...
cm.add_command(label="Информация", command=Get_task)   
